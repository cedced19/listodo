...
describe('Test views files', function () {
    ...
    it('responds to /views/tasks-id.html', function (done) {
      request(app)
        .get('/views/tasks-id.html')
        .expect(200)
        .end(function(err, res) {
            if (err) return done(err);
            done();
    ...
    it('responds to /views/tasks-list.html', function (done) {
      request(app)
        .get('/views/tasks-list.html')
        .expect(200)
        .end(function(err, res) {
            if (err) return done(err);
            done();
